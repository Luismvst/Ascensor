...
entity Top is
    Port ( 
       ...
       --Reloj y reset general
        ...
        abriendo_puerta : in std_logic;                         --para no realizar etapas fugaces, el sensor que verifica que la puerta se ha abierto.
        cerrando_puerta : in std_logic;                         --Lo mismo que abriendo puerta pero al contrario                   
        motor_subir   : out std_logic;                          --Motor sube
        motor_bajar : out std_logic;                            --Motor baja
        motor_puerta_ascensor: out std_logic                    --Motor puerta ( 1 cierra,  0 abre )
